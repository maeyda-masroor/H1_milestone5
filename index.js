...
// @ts-ignore: Importing a JS library without types
...
function generateResume(event) {
    ...
    if (resumeDiv) {
        ...
        (0, html2pdf_js_1.default)(resumeDiv, options);
    }
    else {
        console.error('Resume element not found!');
    }
    var editCV = document.querySelector('#edit');
    if (editCV) {
        editCV.style.display = 'block';
    }
    var urlSection = document.querySelector('#urlSection');
